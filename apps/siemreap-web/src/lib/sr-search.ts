...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: 'Join staff or volunteer', desc: 'Serve long term, or come short term', href: '/staff', group: 'Get involved', keywords: 'staff join team serve long term short term volunteer volunteering mission builders our team', quick: true },
